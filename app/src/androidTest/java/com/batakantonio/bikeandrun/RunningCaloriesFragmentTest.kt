...
import com.batakantonio.bikeandrun.ui.running.RunningCaloriesFragment
import org.junit.Before
import org.junit.Test
import org.junit.runner.RunWith

@RunWith(AndroidJUnit4::class)
class RunningCaloriesFragmentTest {

    private lateinit var scenario: FragmentScenario<RunningCaloriesFragment>
    ...
    fun calculateCalorie_validInput_showsResult() {
        ...
        onView(withId(R.id.btn_calculate_running))
            .perform(click())

        // Checking result
        onView(withId(R.id.tv_calorie_result_running))
    ...
    fun calculateCalorie_invalidInput_showsError() {
        ...
        // Checking result, expecting false - Please input correct input
        onView(withId(R.id.tv_calorie_result_running))
            .check(matches(withText("Please enter correct input")))
